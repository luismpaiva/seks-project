...
public class VectorComparisonService {
    ...
    public ArrayList<String> getSharedConcepts(@WebParam(name = "documentSemanticVector") String documentSemanticVector, @WebParam(name = "querySemanticVector") String querySemanticVector) {
        ...
        HashMap<String, SemanticWeight> documentSV = (HashMap<String, SemanticWeight>) st.Deserialize(documentSemanticVector) ;
        HashMap<String, SemanticWeight> querySV = (HashMap<String, SemanticWeight>) st.Deserialize(querySemanticVector) ;
