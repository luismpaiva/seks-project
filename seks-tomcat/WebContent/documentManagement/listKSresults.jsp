    ...
    <body>
        ...
        %>
                ...
                <%
                	...
                	HashMap<String, SemanticWeight> semanticVector = qt.createQuerySemanticVector(conceptsAndWeights) ;
                ...
                <%
                    ...
                    while (iter.hasNext()) {
                        ...
                        ArrayList<String> sharedConcepts = svc.getSharedConcepts(semanticVector, docSV) ;
                        //IMPORTANTE:  O primeiro vector é o do documento, o segundo é o da query
                        DocumentResult result = svc.compareSemanticVectors(docSV, semanticVector, sharedConcepts) ;
                        results.add(result) ;
                    }
                    if (!results.isEmpty()) {
